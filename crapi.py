...
class crapi(object):
    ...
    def cards(self):
        ...
        best32cards=[]#i added this in today
        bestamount=20
        cards = ''
        ...
        #i added everything between this comment
        ...
        #and this comment, just so you know
        return(card_levels, top_32_average, average, card_list,set([x[0] for x in sortedbest32cards]))#, card_level)
    ...
    def get_current_deck_url(self):
        return(generate_url(convert_id(self.get_current_deck())))
